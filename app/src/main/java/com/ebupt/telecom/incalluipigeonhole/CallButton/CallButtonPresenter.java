...
package com.ebupt.telecom.incalluipigeonhole.CallButton;
...
import com.ebupt.telecom.incalluipigeonhole.AudioModeProvider;
import com.ebupt.telecom.incalluipigeonhole.Call;
import com.ebupt.telecom.incalluipigeonhole.CallList;
import com.ebupt.telecom.incalluipigeonhole.callerInfo.CallerInfoUtils;
import com.ebupt.telecom.incalluipigeonhole.InCallCameraManager;
import com.ebupt.telecom.incalluipigeonhole.InCallPresenter;
import com.ebupt.telecom.incalluipigeonhole.TelecomAdapter;
import com.ebupt.telecom.incalluipigeonhole.base.Log;
import com.ebupt.telecom.incalluipigeonhole.base.Presenter;
import com.ebupt.telecom.incalluipigeonhole.base.Ui;
import com.ebupt.telecom.incalluipigeonhole.utils.CallUtils;

import static com.ebupt.telecom.incalluipigeonhole.CallButton.CallButtonFragment.Buttons.BUTTON_ADD_CALL;
import static com.ebupt.telecom.incalluipigeonhole.CallButton.CallButtonFragment.Buttons.BUTTON_AUDIO;
import static com.ebupt.telecom.incalluipigeonhole.CallButton.CallButtonFragment.Buttons.BUTTON_DIALPAD;
import static com.ebupt.telecom.incalluipigeonhole.CallButton.CallButtonFragment.Buttons.BUTTON_HOLD;
import static com.ebupt.telecom.incalluipigeonhole.CallButton.CallButtonFragment.Buttons.BUTTON_MERGE;
import static com.ebupt.telecom.incalluipigeonhole.CallButton.CallButtonFragment.Buttons.BUTTON_MUTE;
import static com.ebupt.telecom.incalluipigeonhole.CallButton.CallButtonFragment.Buttons.BUTTON_PAUSE_VIDEO;
import static com.ebupt.telecom.incalluipigeonhole.CallButton.CallButtonFragment.Buttons.BUTTON_SWAP;
import static com.ebupt.telecom.incalluipigeonhole.CallButton.CallButtonFragment.Buttons.BUTTON_SWITCH_CAMERA;
import static com.ebupt.telecom.incalluipigeonhole.CallButton.CallButtonFragment.Buttons.BUTTON_UPGRADE_TO_VIDEO;

/**
 * Logic for call buttons.
 */
public class CallButtonPresenter extends Presenter<CallButtonPresenter.CallButtonUi>
        implements InCallPresenter.InCallStateListener, AudioModeProvider.AudioModeListener, InCallPresenter.IncomingCallListener,
        InCallPresenter.InCallDetailsListener, InCallPresenter.CanAddCallListener, InCallCameraManager.Listener {
    ...
    public void onUiReady(CallButtonUi ui) {
        ...
        onStateChange(InCallPresenter.InCallState.NO_CALLS, inCallPresenter.getInCallState(),
    ...
    public void onStateChange(InCallPresenter.InCallState oldState, InCallPresenter.InCallState newState, CallList callList) {
        ...
        if (newState == InCallPresenter.InCallState.OUTGOING) {
            ...
            // the dialpad too.)
            if (ui != null) {
                if (oldState == InCallPresenter.InCallState.OUTGOING && mCall != null) {
                    if (CallerInfoUtils.isVoiceMailNumber(ui.getContext(), mCall)) {
                        ui.displayDialpad(true /* show */, true /* animate */);
                    }
                }
            }
        } else if (newState == InCallPresenter.InCallState.INCOMING) {
            if (ui != null) {
    ...
    private void updateUi(InCallPresenter.InCallState state, Call call) {
