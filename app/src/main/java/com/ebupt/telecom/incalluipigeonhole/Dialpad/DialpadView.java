...
import com.ebupt.telecom.incalluipigeonhole.utils.LocaleUtils;
...
public class DialpadView extends LinearLayout {
  ...
  private int getKeyButtonAnimationDelay(int buttonId) {
    ...
    Log.e(TAG, "Attempted to get animation delay for invalid key button id.");
    return 0;
  }
  ...
  private int getKeyButtonAnimationDuration(int buttonId) {
    ...
    Log.e(TAG, "Attempted to get animation duration for invalid key button id.");
    return 0;
  }
