package com.ebupt.telecom.incalluipigeonhole.notification;
        ...
        if (activeNotifications.length > HIGH_GLOBAL_NOTIFICATION_COUNT
            ...
            Log.i(
                    ...
                    "app has "
                            ...
                            " notifications, system may suppress future notifications");
...
//                    .logImpression(DialerImpression.Type.HIGH_GLOBAL_NOTIFICATION_COUNT_REACHED);
        ...
        if (count > MAX_NOTIFICATIONS_PER_TAG) {
            Log.i(
                    "NotificationThrottler.throttle",
                    String.format(Locale.CHINA, "groupKey: %s is over limit, count: %d, limit: %d",
                    groupKey,
                    count,
