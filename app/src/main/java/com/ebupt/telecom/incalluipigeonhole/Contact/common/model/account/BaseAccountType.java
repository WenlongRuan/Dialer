...
package com.ebupt.telecom.incalluipigeonhole.Contact.common.model.account;
...
import com.ebupt.telecom.incalluipigeonhole.utils.CommonDateUtils;
import com.ebupt.telecom.incalluipigeonhole.utils.ContactDisplayUtils;
...
public abstract class BaseAccountType extends AccountType {
  ...
  protected final void parseEditSchema(Context context, XmlPullParser parser, AttributeSet attrs)
    ...
    while ((type = parser.next()) != XmlPullParser.END_DOCUMENT
      ...
      if (Tag.DATA_KIND.equals(tag)) {
        ...
        Log.i("BaseAccountType.parseEditSchema", "Skipping unknown tag " + tag);
      }
    }
  }
  ...
  private abstract static class KindBuilder {
    ...
    protected final DataKind newDataKind(
      ...
      Log.d("BaseAccountType.newDataKind", "Adding DataKind: " + mimeType);
