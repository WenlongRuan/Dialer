...
import com.ebupt.telecom.incalluipigeonhole.Contact.common.preference.ContactsPreferences;
...
public class ContactDisplayUtils {
  ...
  /**
   * Returns either namePrimary or nameAlternative based on the {@link }.
