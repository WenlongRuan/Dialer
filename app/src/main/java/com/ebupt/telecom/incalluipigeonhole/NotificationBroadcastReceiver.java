...
public class NotificationBroadcastReceiver extends BroadcastReceiver {
    ...
    public static final String ACTION_DECLINE_INCOMING_CALL =
            "com.ebupt.telecom.incalluipigeonhole.ACTION_DECLINE_INCOMING_CALL";
    public static final String ACTION_HANG_UP_ONGOING_CALL =
            "com.ebupt.telecom.incalluipigeonhole.ACTION_HANG_UP_ONGOING_CALL";
    public static final String ACTION_ANSWER_VIDEO_INCOMING_CALL =
            "com.ebupt.telecom.incalluipigeonhole.ACTION_ANSWER_VIDEO_INCOMING_CALL";
    public static final String ACTION_ANSWER_VOICE_INCOMING_CALL =
            "com.ebupt.telecom.incalluipigeonhole.ACTION_ANSWER_VOICE_INCOMING_CALL";
    public static final String ACTION_ACCEPT_VIDEO_UPGRADE_REQUEST =
            "com.ebupt.telecom.incalluipigeonhole.ACTION_ACCEPT_VIDEO_UPGRADE_REQUEST";
    public static final String ACTION_DECLINE_VIDEO_UPGRADE_REQUEST =
            "com.ebupt.telecom.incalluipigeonhole.ACTION_DECLINE_VIDEO_UPGRADE_REQUEST";
