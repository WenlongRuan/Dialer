...
public class MoreContactUtils {
   ...
   * PhoneNumberUtils#compare(Context, String, String)} instead
   */
  ...
  /**
   * Returns the {@link Rect} with left, top, right, and bottom coordinates that
   * are equivalent to the given {@link View}'s bounds. This is equivalent to how the
   * target {@link Rect} is calculated in {@link
...
//   * TextView} is set using the given textResourceId.
//   */
